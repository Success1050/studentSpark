            ...
            <main className="relative flex w-full max-w-5xl flex-col lg:flex-row items-center overflow-hidden rounded-[2.5rem] bg-white dark:bg-zinc-900 shadow-2xl xl:min-h-[700px]">
              ...
              <div className="relative w-full lg:w-1/2 flex flex-col justify-between p-8 lg:p-16 h-full min-h-[400px]">
                ...
                <div className="mt-12 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2.5">
                    {onboardingSteps.map((_, index) => (
                      <button
                        ...
                        className={`relative h-2 rounded-full transition-all duration-500 overflow-hidden cursor-pointer ${index === currentStep
                  ...
                  <button
                    onClick={handleNext}
                    className={`group flex items-center justify-center gap-2 px-8 py-4 rounded-2xl text-white font-bold transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-xl ${isLastStep
